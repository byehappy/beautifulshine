        ...
        <ContainerSlider>
            <Carousel showStatus={false} emulateTouch={true}>
                <div style={{height: "20vw",position: 'relative'}}>
                        ...
                        <Image src='/images/slider/slider1.jpg' alt='SliderOne' fill style={{objectFit: "cover"}}/>
                </div>
                <div style={{height: "20vw",position: 'relative'}}>
                        <div style={{fontSize: '3.5vw',color: 'white',position: 'absolute',zIndex: '2',bottom:'2.5vw',left: '50%',transform:'translate(-50%,0)'}}>Fao - кольца твоей мечты</div>
                        ...
                        <Image src='/images/slider/slider2.jpg' alt='SliderOne' fill style={{objectFit: "cover"}}/>
                </div>
                <div style={{height: "20vw",position: 'relative'}}>
                        <div style={{fontSize: '3.5vw',color: 'white',position: 'absolute',zIndex: '2',bottom:'2.5vw',left: '50%',transform:'translate(-50%,0)'}}>Fao - кольца твоей мечты</div>
                        ...
                        <Image src='/images/slider/slider3.jpg' alt='SliderOne' fill style={{objectFit: "cover"}} objectPosition='50% 55%'/>
                </div>
            </Carousel>
        </ContainerSlider>
    );
